...
/** Expected precision of the sensor readings. */
static constexpr std::uint32_t SENSOR_PRECISION = {
    static_cast<std::uint32_t>(
        (1 << MEASUREMENT_BITS) * (SENSOR_REF_V - (SENSOR_MAX_V - SENSOR_MIN_V)))
};
